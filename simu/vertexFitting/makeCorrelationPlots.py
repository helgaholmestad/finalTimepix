...
scatterCenter.GetXaxis().SetTitleSize(0.06)
scatterCenter.GetYaxis().SetTitleSize(0.06)
...
scatterCenter.SetMarkerStyle(20)
scatterCenter.Draw('ap')
can2.Print("../../fig/prongCenter.pdf")
...
scatterAngle.GetXaxis().SetTitleSize(0.06)
scatterAngle.GetYaxis().SetTitleSize(0.06)
scatterAngle.GetXaxis().SetTitleOffset(0.8)
scatterAngle.GetYaxis().SetTitleOffset(0.7)
scatterAngle.Draw('ap')
can2.Print("../../fig/prongAngle.pdf")
...
scatterLength.GetXaxis().SetTitleSize(0.06)
scatterLength.GetYaxis().SetTitleSize(0.06)
...
# prongAngle.Draw()
can2.Print("../../fig/prongLength.pdf")
...
scatterSize.GetXaxis().SetTitleSize(0.06)
scatterSize.GetYaxis().SetTitleSize(0.06)
